class BiographiesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @biography.update(biography_params)
        format.html { redirect_to @biography, notice: "Biography was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to biographies_path, notice: "Biography was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def set_biography
      @biography = Biography.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def biography_params
      params.expect(biography: [ :biography, :quote_id, :author_id ])
    end
end
